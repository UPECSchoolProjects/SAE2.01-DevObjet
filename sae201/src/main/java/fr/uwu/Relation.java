...
public class Relation {
    ...
    */
     ...
     * Le temps de trajet entre ces deux quais, formatées dans une chaîne de caractères.
    ...
    */
     ...
     * Cette méthode permet d'obtenir le quai qui est relié à cette relation et qui est différent du quai spécifié.
     * Si le quai spécifié correspond à st1, la méthode retourne st2. 
     * Si le quai spécifié correspond à st2, la méthode retourne st1. 
     * Si le quai spécifié ne correspond à aucun des quais de la relation, la méthode retourne null.
    ...
    */
     ...
     * Cette méthode compare les attributs de cette relation avec ceux de la relation spécifiée. 
     * Si tous les attributs sont identiques, la méthode retourne true, sinon elle retourne false.
